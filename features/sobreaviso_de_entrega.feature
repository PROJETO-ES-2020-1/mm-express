Feature: Um morador pode gerenciar seus sobreavisos de entrega de encomendas
    ...
    Given ha um usuario do tipo funcionario logado
    And ha um usuario de nome 'Eleanor Walker', email "eleanor@gmail.com", password "eleanorpassword", password confimation "eleanorpassword",  telefone "89653210", cpf: '938.431.650-41',  numero residencia: '5', bloco_residencia: '2' e isMorador "Sim" cadastrado por um funcionario
    And O usuario logado faz logout
    ...
    And eu preencho a data prevista para chegada com '2021 July 20' e urgencia de repasse 'Baixa'
    ...
    And O usuario logado faz logout
    And estou logado no sistema com um usuario que possui email 'eleanor@gmail.com' e senha 'eleanorpassword'
    And existe um sobreaviso ja criado com data prevista para chegada com '2021 July 20' e urgencia de repasse 'Baixa'
    ...
    And eu preencho a data prevista para chegada com '2021 July 20' e urgencia de repasse 'Alta'
    ...
    And clico no link para deletar o sobreaviso que tem data prevista de entrega '2021 July 20' e urgencia de repasse 'Baixa'
